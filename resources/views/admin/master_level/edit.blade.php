            ...
            <div class="card-body">
              <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="name" class="form-control" id="name" value="{{ $data->name }}" placeholder="Masukkan Judul Buku">
                </div>
                <div class="form-group col-md-6">
                    <label for="sampul">Minimal Poin</label>
                    <input type="number" name="min_poin" class="form-control" id="min_poin" value="{{ $data->point_requirement }}" placeholder="Masukkan Jumlah Minimal Poin">
                </div>
              </div>
              <div class="row">
                <div class="form-group col-md-6">
                    <label for="nama_buku">Maksimal Pinjam Buku</label>
                    <input type="number" name="max_pinjam_buku" class="form-control" id="max_pinjam_buku" value="{{ $data->max_borrow }}" placeholder="Masukkan Jumlah Maksimal Pinjam Buku">
                </div>
                <div class="form-group col-md-6">
                    <label for="sampul">Reset Poin</label>
                    <input type="number" name="reset_poin" class="form-control" id="reset_poin" value="{{ $data->reset_point }}" placeholder="Masukkan Jumlah Reset Poin">
                </div>
              </div>
            </div>
            <!-- /.card-body -->
