...
@section('subtitle', 'Edit Izin')
@section('content_header_title', 'Master Absensi')
@section('content_header_subtitle', 'Edit Izin')
          ...
          <form id="quickForm">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="date" name="tanggal" class="form-control" id="tanggal" placeholder="Pilih Tanggal Izin" value="{{ $izin->tanggal }}">
              </div>
              <div class="form-group">
								<label for="durasi">Durasi Izin (Hari)</label>
                <input type="number" min="1" max="3" name="durasi" class="form-control" id="durasi" placeholder="Masukkan Durasi Izin" value="{{ $izin->qty }}">
              </div>
              <div class="form-group">
...
@push('js')
  <script>
    $(function() {
			...
			$('#siswa').val('{{ $izin->user_id }}').trigger('change');
			$('#keterangan').val('{{ $izin->keterangan }}');
        ...
        submitHandler: function() {
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              $.ajax({
                url: '{{ route('master-izin.update', $izin) }}',
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
